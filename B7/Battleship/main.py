...
class Ship:
    def __init__(self, bow, l_, o):
        self.bow = bow
        self.l_ = l_  # length
        self.o = o  # orientation(0-hor,1-vert)
        self.lives = l_  # lives
...
class Board:
    ...
    def contour(self, ship, vis=False):
        near = [
            (-1, -1), (-1, 0), (-1, 1),
            (0, -1), (0, 0), (0, 1),
            (1, -1), (1, 0), (1, 1)
...
class Game:
    ...
    def print_boards(self):
        li = str(self.us.board).splitlines()
        user_list = ["-" * 27, "Доска пользователя:        "]
        user_list.extend(li)
        user_list.append("-" * 27)

        li_2 = str(self.ai.board).splitlines()
        ai_list =["-" * 27, "Доска компьютера:"]
        ai_list.extend(li_2)
        ai_list.append("-" * 27)
