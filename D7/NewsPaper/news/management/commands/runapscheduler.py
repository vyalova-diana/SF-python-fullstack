...
from news.management.jobs import weekly_category_email
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            weekly_category_email,
            trigger=CronTrigger(day_of_week="mon", hour="00", minute="00"),
            # То же самое что и интервал, но задача триггера таким образом более понятна django
            id="weekly_category_email",  # уникальный id
            max_instances=1,
            replace_existing=True,
        )
        logger.info("Added job 'weekly_category_email'.")
